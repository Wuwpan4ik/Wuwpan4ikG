...
function appendMessage(name, img, side, text, id) {
    ...
    <div class="msg ${side}-msg">
      ...
      ${side == "right" ? `<div class='msg-options'><button class="btnRefreshMessage" onclick="refreshCommandBtn(this)">
