...
<!--Отправка заявки на пополнение аккаунта-->
<div class="loaderResponse error" id="loaderResponseZayavka">
    <div class="firstRow">
        <div class="loaderGif">
            <lottie-player src="{{asset('assets/success.json')}}"  background="transparent" speed="1" loop autoplay></lottie-player>
        </div>
        <div class="responseStat">
            <p>{{__('loaderResponseZayvka')}}</p>
            <span>{{__("loaderResponseZayavkaH")}}</span>
        </div>
    </div>
    <div class="secondRow">
